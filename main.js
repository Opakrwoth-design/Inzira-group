...
function activateTab(index) {
    ...
    setTimeout(() => {
        ...
        serviceDesc.textContent = serviceData[index].description;
        serviceImage.src = serviceData[index].image;
        serviceImage.alt = serviceData[index].title;
...
if (serviceTitle) {
    serviceTitle.style.transition = 'opacity 0.25s ease';
    serviceDesc.style.transition = 'opacity 0.25s ease';
}
